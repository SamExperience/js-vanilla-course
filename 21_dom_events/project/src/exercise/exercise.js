...
export function runExercise() {
  ...
  if (buttonElement) console.log(">>> ButtonElement:", buttonElement);
  else console.log("🔴Button: your selector is wrong or null!");
  ...
  buttonElement.addEventListener("click", () => {
    console.log(">>>🟢Button listener  ok!");
    ...
    buttonElement.textContent = isDark ? "switch to light" : "switch to dark";
  });
  ...
  if (favList) console.log(">>> favList:", favList);
  else console.log("favList: your selector is wrong or null!");
  ...
  favList.addEventListener("click", (event) => {
    ...
    console.log(">>>closest item content:", item.textContent);
  });
  ...
  document.addEventListener("keydown", (event) => {
    /* const allElements = favList.querySelectorAll("li");
